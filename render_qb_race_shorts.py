...
OUTPUT_DIR = "output"
OUTPUT_BASENAME = "qb_passing_yards_race_2025_shorts"
OUT_MP4 = os.path.join(OUTPUT_DIR, f"{OUTPUT_BASENAME}.mp4")
...
SAVE_STILL = True
STILL_FRAME_IDX = 0
STILL_PATH = os.path.join(OUTPUT_DIR, "frame_0000_shorts.png")
SAVE_VIDEO = True
...
def ensure_headshot(player: str, headshot_map: dict[str, str]):
...
def update(idx):
    ...
    for i, (player, val) in enumerate(zip(names, vals)):
        ...
        ensure_headshot(player, headshot_map)
